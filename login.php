			...
			<div class="signup-align">
				<form name="login" action="" method="post" onsubmit="return loginValidation()">
					<div class="signup-heading"
						style="color:white;text-align: center;font-family: cooper;font-size: 51px;">Login</div>
				...
				New to Mini Theater ? <a href="user_registration.php" style="color:white;">Sign up now.</a>
		</div>
	</div>
	</form>
	</div>
