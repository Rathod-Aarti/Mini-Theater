...
<div >
  ...
  <table class="table ">
    ...
    ?>
    <tr>
      <td style="width: 500px;"><?=$count?></td>
      <td style="width: 500px;"><?=$row["category_name"]?></td>   
      <!-- <td><button class="btn btn-primary" >Edit</button></td> -->
      <td style="width: 500px;"><button class="btn btn-danger" style="height:40px" onclick="categoryDelete('<?=$row['category_id']?>')">Delete</button></td>
      </tr>
      <?php
            $count=$count+1;
          }
